...
export const financialFields = [
  ...
  { key: 'shares_outstanding', label: '発行株式数', category: 'stock', unit: '株' },
  ...
  { key: 'current_business_value', label: '現状事業価値', category: 'valuation', unit: '百万円' },
  { key: 'current_asset_value', label: '現状資産価値', category: 'valuation', unit: '百万円' },
  { key: 'current_theoretical_stock_price', label: '現状理論株価', category: 'valuation', unit: '円' },
  { key: 'margin_of_safety_current', label: '安全域(現状)', category: 'valuation', unit: '%' },
